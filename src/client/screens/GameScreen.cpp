...
GameScreen::GameScreen(screen::ScreenManager &screenManager, std::string mapPath)
    : m_screenManager(screenManager), m_mapPath(std::move(mapPath)), m_simulation(), m_renderer() {}
...
void GameScreen::onEnter() {
    ...
    if (!result) {
        ...
        m_screenManager.setScreen(std::make_unique<MenuScreen>(m_screenManager, m_mapPath));
        return;
    }

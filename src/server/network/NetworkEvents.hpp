...
struct PlayerConnectedEvent    { core::PlayerId playerId; };
struct PlayerDisconnectedEvent { core::PlayerId playerId; };
struct LobbyReadyEvent         { core::PlayerId playerId; bool ready; };
struct ReadyToPlayEvent        { core::PlayerId playerId; };
struct PlayerInputEvent        { core::protocol::PlayerInputPacket packet; };
...
using ServerNetworkEvent = std::variant<
    UnknownPacketEvent,

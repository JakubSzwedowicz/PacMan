...
RuleEvents AuthoritativeLogic::applyRules(entt::registry &registry,
...
void AuthoritativeLogic::checkPelletPickup(entt::registry &registry,
                                            const core::maps::Map &map) {
  float ts = map.tileSize;

  auto pacView = registry.view<const core::ecs::Position, core::ecs::PlayerState,
...
bool AuthoritativeLogic::checkPowerPellet(entt::registry &registry,
                                           const core::maps::Map &map) {
  float ts = map.tileSize;

  auto pacView = registry.view<const core::ecs::Position, core::ecs::PlayerState,
                                const core::ecs::PacManTag>();
  auto ppView = registry.view<const core::ecs::Position,
...
void AuthoritativeLogic::checkGhostCollision(entt::registry &registry,
                                              const core::maps::Map &map) {
  float ts = map.tileSize;

  auto pacView = registry.view<const core::ecs::Position, core::ecs::PlayerState,
                                const core::ecs::PacManTag>();
  auto ghostView = registry.view<const core::ecs::Position,
                                  core::ecs::GhostState,
